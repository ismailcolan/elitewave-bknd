	                    ...
	                    <div class="widget-container fluid-height clearfix">
	                        ...
	                        <div class="widget-content padded">
	                            ...
	                            <form id="grn_details" class="form-horizontal" enctype="multipart/form-data">
									<input type="text" name="truck_type" id="truck_type" value="<?php echo $ftl_type; ?>" />
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-lg-8">
                                                        ...
                                                        ?>
                                                            ...
                                                            if ($row['grn_no'] != '') {
                                                            ?>
																<input type="text" id="grn_no" name="grn_no" value="<?php echo $row['grn_no']; ?>" class="form-control" readonly />
	                                                        <?php
                                                            } else {
                                                            ?>
	                                    ...
	                                    <div class="col-md-5">
											...
											<td><input type="text" name="octroi_amount" id="octroi_amount" value="<?php echo $row['octroi_amount']; ?>"  class="form-control calculation"/></td>
														...
														<tr id="rajdhani_ex" style="display: none;">
															...
															<td><input type="text" name="rajdhani_charges" id="rajdhani_charges" value="<?php echo $row['rajdhani_charges']; ?>" class=" text-right form-control calculation" onchange="sum_amount();" /></td>
														</tr>
	                                                    <tr>
	    ...
	    <script type="text/javascript">
			...
			function party_invoice_details() {
				...
				if (conr_id != "" && conr_id != null) {
					...
					$.ajax({
						url: '<?php echo site_path; ?>fetch_details.php',
						type: "GET",
						dataType: "JSON",
						data: {
							cmd: cmd,
	        ...
	        $(document).ready(function() {
	            ...
	            $(document).on('click', '#save', function() {
					...
					//return;
					if ($('#grn_details').valid() == true && chck_key == true && file_receipt_validate == false) {

...
<div class="container-fluid main-content new_dpt_bottom">
		...
		<div class="row">
		  <div class="col-md-offset-1 col-md-10">
					...
					<div class="widget-container fluid-height clearfix">
						<div class="heading"> <i class="fa fa-table" ></i> List of Branch  <span class="align-right"><i class="fa fa-plus" ></i><a href="branch.php">ADD BRANCH</a></span></div>
		...
		//button Save
			$(document).on('click','#save',function(){
				var data = $('#branch_form').serialize();
				duplicate_check();
				if($('#branch_form').valid() == true && dup_chk)
				{
		...
		//Active Inactive
			$(document).on('click', '.btn-active', function(ev){
				...
				$.post('save_details.php', { form_name: "inacv_branch", tbl_id: $(this).attr("id"),status:status1}, function(data,status){
					console.log(data);
					if(data == 1){
						$(".form-data-saving").hide();
						$("#alert-status").text("");

...
(function(C, Z) {
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, k = [];
            ...
            if (d) {
                ...
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = S.lang, i =
    ...
    var z, A = C.document,
        ...
        ca = A &&
        A.createElementNS && !!A.createElementNS(Ga, "svg").createSVGRect,
        Pb = La && parseInt(za.split("Firefox/")[1], 10) < 4,
        ia = A && !ca && !ya && !!A.createElement("canvas").getContext,
        cb, db, Mb = {},
        zb = 0,
        ib, S, Pa, G, Aa = function() {},
        O = [],
        eb = 0,
        Ka = "div",
        Qb = /^[0-9]+$/,
        nb = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
        pa, jb, rb, Za, ub, vb, wb, Ua, ab, bb, Fb, Gb, Hb, Ib, kb, xb, yb, I = {},
        w;
    ...
    qb.prototype = {
        ...
        initPath: function(a, b, c) {
            ...
            a.shift = 0;
            if (b.length)
                for (a = c.length; b.length < a;) d = b.slice().splice(b.length /
                    i - f, f * i), e && (d[f - 6] = d[f - 2], d[f - 5] = d[f - 1]), [].splice.apply(b, [b.length / i, 0].concat(d));
            return [b, c]
        }
    };
    ...
    w.numberFormat = function(a, b, c, d) {
        ...
        a = a < 0 ? "-" : "";
        a += h ? g.substr(0, h) + d : "";
        a += g.substr(h).replace(/(\d{3})(?=\d)/g, "$1" + d); + b && (d = Math.abs(i - g + Math.pow(10, -Math.max(b,
            f) - 1)), a += c + d.toFixed(b).slice(2));
        return a
    };
    ...
    H = function(a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, c = c || {};
        if (A.createEvent && (a.dispatchEvent || a.fireEvent)) e = A.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, s(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e);
        else if (e) {
            e = e[b] || [];
            f = e.length;
    ...
    Wa = function(a, b, c) {
        ...
        c.curAnim = D(b);
        for (h in b) g = new qb(a, c, h), f = null, h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(ka(a, h)) || 0, h !== "opacity" && (e = "px")), f || (f = b[h]), f.match && f.match("px") && (f = f.replace(/px/g, "")), g.run(d, f, e)
    };
    if (C.jQuery) C.jQuery.fn.highcharts =
        function() {
    ...
    P.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                v = v.join(",");
                i[v] ? n = i[v].attr("id") : (g.id = n = "highcharts-" + zb++, i[v] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [],
                    o(j, function(a) {
        ...
        on: function(a, b) {
            ...
            db && a === "click" ? (d.ontouchstart = function(a) {
                ...
                (za.indexOf("Android") === -1 || pa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || xa(c)) this.alignTo = d = c || "renderer", na(f, this), f.push(this), c = null
            ...
            if (!c) {
                if (h.namespaceURI === Ga || d.forExport) {
                    try {
                        ...
                        }, La && j.textShadow ? (k = j.textShadow, j.textShadow = "") : l && l("none"), c = h.getBBox ? s({}, h.getBBox()) : {
                            width: h.offsetWidth,
                ...
                if (d.isSVG) {
                    ...
                    if (f) c.width = Q(e * aa(g)) + Q(d * U(g)), c.height = Q(e * U(g)) + Q(d * aa(g))
                }
                if (q) {
        ...
        titleSetter: function(a) {
            ...
            b.appendChild(A.createTextNode(String(p(a),
                "").replace(/<[^>]*>/g, "")))
        },
        ...
        zIndexSetter: function(a, b) {
            ...
            e = this.added;
            var i;
            if (r(a)) g.zIndex = a, a = +a, this[b] === a &&
                (e = !1), this[b] = a;
            if (e) {
                if ((a = this.zIndex) && d) d.handleZ = !0;
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = e.zIndex, e !== g && (F(f) > a || !r(a) && r(f))) c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    Ca.prototype = {
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1,
                    g = b.childNodes, h, i, k = K(b, "x"), j = a.styles, l = a.textWidth, m = j && j.lineHeight, n = j && j.textShadow, q = j && j.textOverflow === "ellipsis", v = g.length, y = l && !a.added && this.box, sa = function(a) {
                        return m ? F(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12, a).h
                    }, x = function(a) {
                        return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                    }; v--;) b.removeChild(g[v]);
            !f && !n && !q && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/,
                    ...
                    o(g, function(e) {
                        if (e !== "" || g.length === 1) {
                            var n = {},
                                ...
                                y;
                            h.test(e) && (y = e.match(h)[1].replace(/(;| |^)color([ :])/,
                                "$1fill$2"), K(v, "style", y));
                            ...
                            if (e !== " ") {
                                ...
                                if (l) {
                                    for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, u, r, t = [], s = sa(v), B = 1, z = a.rotation, w = e, D = w.length;
                                        (p || q) && (n.length ||
                                            t.length);) a.rotation = 0, o = a.getBBox(!0), r = o.width, !ca && c.forExport && (r = c.measureSpanWidth(v.firstChild.data, a.styles)), o = r > l, u === void 0 && (u = o), q && u ? (D /= 2, w === "" || !o && D < 0.5 ? n = [] : (o && (u = !0), w = e.substring(0, w.length + (o ? -1 : 1) * ua(D)), n = [w + (l > 3 ? "\u2026" : "")], v.removeChild(v.firstChild))) : !o || n.length === 1 ? (n = t, t = [], n.length && (B++, v = A.createElementNS(Ga, "tspan"), K(v, {
                                        dy: s,
                                        x: k
                                    }), y && K(v, "style", y), b.appendChild(v)), r > l && (l = r)) : (v.removeChild(v.firstChild), t.unshift(n.pop())), n.length && v.appendChild(A.createTextNode(n.join(" ").replace(/- /g,
                                        "-")));
        ...
        symbols: {
            ...
            callout: function(a, b, c, d, e) {
                var f = E(e && e.r || 0, c, d),
                    ...
                    e = e && e.anchorY,
                    i;
                i = ["M", a + f, b, "L", a + c - f, b, "C", a + c, b, a + c, b, a + c, b +
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            J = function() {
                ...
                if (A) {
                    if (!m) a = ob, b = (h ? -w : 0) + ob, j.box = m = d ? k.symbol(d, a, b, j.width, j.height, Y) : k.rect(a, b, j.width, j.height, 0, Y["stroke-width"]), m.isImg || m.attr("fill", "none"), m.add(j);
                    m.isImg || m.attr(s({
                        width: B(j.width),
                        height: B(j.height)
                    }, Y));
    ...
    s(P.prototype, {
        htmlCss: function(a) {
            ...
            if (b = a && b.tagName === "SPAN" &&
                a.width) delete a.width, this.textWidth = b, this.updateTransform();
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (b.offsetWidth > j &&
                            /[ \-]/.test(b.textContent || b.innerText)) L(b, {
                            width: j + "px",
                            display: "block",
                            whiteSpace: l || "normal"
                        }), this.hasTextWidth = !0;
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = ya ? "-ms-transform" : mb ? "-webkit-transform" : La ? "MozTransform" :
                Kb ? "-o-transform" : "";
    ...
    if (!ca && !ia) {
        M = {
            ...
            clip: function(a) {
                var b = this,
                    c;
                a ? (c = a.members, na(c, b), c.push(b), b.destroyClip =
                    function() {
                        na(c, b)
            ...
            visibilitySetter: function(a, b, c) {
                ...
                c.nodeName === "DIV" && (a = a === "hidden" ? "-999em" : 0, lb || (c.style[b] = a ? "visible" : "hidden"),
                    b = "top");
                c.style[b] = a
            },
        ...
        var Bb = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / qa) + '"', t();
                        else {
                            var k = m.r,
                                Y = k * 2,
                                s = k * 2,
                                ...
                                A, k = function() {
                                    ...
                                    x = 'src="' +
                                        S.global.VMLRadialGradientURL + '" size="' + Y + "," + s + '" origin="0.5,0.5" position="' + w + "," + B + '" color2="' + p + '" ';
                                    t()
                                };
                            d.added ? k() : d.onAdd = k;
                            k = y
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = ja(a), d[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb");
                else {
    ...
    Va.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m) d.opposite && (m[0] = -m[0]), h = this.getMarkPath(Y, t, m[0], m[1] * s, g, f), o ? o.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(Y)) i.xy = t = this.getLabelPosition(Y, t, i, g, j, r, a, x), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? u = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(t), x && a % x && (u = !1), u && !isNaN(t.y) ? (t.opacity = c, i[this.isNew ? "attr" : "animate"](t), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Ra(this, this.axis)
        }
    ...
    w.PlotLineOrBand.prototype = {
        render: function() {
            ...
            else if (n && n.length && (a.svgElem = m = u.path(n).attr(x).add(), o))
    ...
    fa.prototype = {
        ...
        init: function(a, b) {
            ...
            this.crosshair =
                p(d.crosshair, ta(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === z;) c = Math.pow(1E3, f + 1), a >= c && b * 10 %
                    c === 0 && e[f] !== null && (g = w.numberFormat(b / c, -1) + e[f]);
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        f = c.dataMax;
                        c = c.dataMin;
                        if (r(c) && r(f)) a.dataMin = E(p(a.dataMin, c), c), a.dataMax = t(p(a.dataMax, f), f);
        ...
        adjustForMinRange: function() {
            var a =
                ...
                f, g, h, i, k, j;
            if (this.isXAxis && this.minRange === z && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null : (o(this.series, function(a) {
                i = a.xData;
                for (g = k = a.xIncrement ? 1 : i.length - 1; g > 0; g--)
                    if (h = i[g] - i[g - 1], f === z || h < f) f = h
        ...
        setTickInterval: function(a) {
            ...
            if (e) !a && E(b.min, p(b.dataMin, b.min)) <= 0 &&
                Z(10, 1), b.min = da(f(b.min), 15), b.max = da(f(b.max), 15);
            if (b.range && r(b.max)) b.userMin = b.min = x = t(b.min, b.minFromRange()), b.userMax = u = b.max, b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!n && !b.axisPointRange && !b.usePercentage && !i && r(b.min) && r(b.max) && (f = b.max - b.min)) !r(x) && j && (b.min -= f * j), !r(u) && k && (b.max += f * k);
            if (ma(d.floor)) b.min = t(b.min, d.floor);
            if (ma(d.ceiling)) b.max = E(b.max, d.ceiling);
            if (v && r(b.dataMin))
                if (q = q || 0, !r(x) && b.min < q && b.dataMin >= q) b.min = q;
                else if (!r(u) && b.max >
                q && b.dataMax <= q) b.max = q;
        ...
        zoom: function(a, b) {
            var c = this.dataMin,
                ...
                f = E(c, p(e.min, c)),
                e = t(d, p(e.max, d));
            this.allowZoomOutside || (r(c) && a <= f && (a = f), r(d) && b >= e &&
                (b = e));
        ...
        unsquish: function() {
            var a = this.options.labels,
                ...
                c = this.tickInterval,
                d = c,
                e = this.len / (((this.categories ? 1 : 0) + this.max - this.min) /
                    c),
                f, g = a.rotation,
                h = this.labelMetrics(),
            ...
            b ? (j = !a.staggerLines && !a.step && (r(g) ? [g] : e < p(a.autoRotationLimit, 80) && a.autoRotation)) && o(j, function(a) {
                var b;
                if (a === g || a && a >= -90 && a <= 90) i = l(Q(h.h / aa(ha * a))), b = i + Q(a / 360), b < k && (k = b, f = a, d = i)
            }) : a.step || (d = l(h.h));
            this.autoRotation = j;
        ...
        renderUnsquish: function() {
            ...
            if (this.labelAlign = e.align ||
                this.autoLabelAlign(this.labelRotation)) i.align = this.labelAlign;
            o(c, function(a) {
                var b = (a = d[a]) && a.label;
                if (b) b.attr(i), l && b.css(D(l, b.specCss)), delete b.specCss, a.rotation = i.rotation
            });
        ...
        getOffset: function() {
            ...
            if (k || a.isLinked) {
                if (o(e,
                    ...
                    }), a.staggerLines) y *= a.staggerLines, a.labelOffset = y * (a.opposite ? -1 : 1)
            } else
            ...
            if (q && q.text && q.enabled !== !1) {
                ...
                if (j) l = a.axisTitle.getBBox()[g ? "height" : "width"], m = q.offset, n = r(m) ? 0 : p(q.margin, g ? 5 : 10);
            ...
            x[h] = t(x[h], a.axisTitleMargin +
                l + u * a.offset, n, k && e.length && Y ? Y[0] : 0);
        ...
        render: function() {
            ...
            if (a.hasData() || g) {
                ...
                n && o(h, function(c, d) {
                    ...
                    if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -q : q)) l[c] || (l[c] = new w.PlotLineOrBand(a)), t = c + q, l[c].options = {
                        from: e ? f(t) : t,
                        to: e ? f(s) : s,
                        color: n
            ...
            if (v) p = a.getLinePath(v), a.axisLine ? a.axisLine.animate({
                d: p
            ...
            if (i && x) i[i.isNew ? "attr" : "animate"](a.getTitlePosition()), i.isNew = !1;
    ...
    fa.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            if (k === G.week) i[kb](i[Ua]() -
                i[wb]() + p(d, 1));
            b = 1;
            if (rb || Za) i = i.getTime(), i = new pa(i + Ya(i));
            h = i[bb]();
            for (var d = i.getTime(), l = i[ab](), m = i[Ua](), n = !g || !!Za, q = (G.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % G.day; d < c;) e.push(d), k === G.year ? d = jb(h + b * j, 0) : k === G.month ? d = jb(h, l + b * j) : n && (k === G.day || k === G.week) ? d = jb(h, l, m + b * j * (k === G.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            o(Ma(e, function(a) {
    ...
    fa.prototype.getLogTickPositions = function(a,
        b, c, d) {
        var e = this.options,
            f = this.len,
            g = this.lin2log,
        ...
        if (a >= 0.5) a = B(a), i = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = T(b), k, j, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) {
                j = e.length;
                for (k = 0; k < j && !n; k++) l = h(g(f) * e[k]), l > b && (!d || m <= c) && m !== z && i.push(m), m > c && (n = !0), m = l
            } else if (b = g(b), c = g(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval /
                    (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = tb(a, null, sb(a)), i = Ba(this.getLinearTickPositions(a, b, c), h), !d) this._minorAutoInterval = a / 5;
    ...
    Ob.prototype = {
        ...
        move: function(a, b, c, d) {
            var e = this,
                f = e.now,
                g = e.options.animation !== !1 && !e.isHidden && (Q(a - f.x) > 1 ||
                    Q(b - f.y) > 1),
        ...
        refresh: function(a, b) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (Na(d), d.attr("opacity",
                1).show()), d.attr({
                text: k
    ...
    Xa.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (w.Tooltip && b.tooltip.enabled) a.tooltip = new Ob(a, b.tooltip), this.followTouchMove = p(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        },
        ...
        runPointActions: function(a) {
            ...
            else c = g && g.tooltipOptions.followPointer, d && c &&
                !d.isHidden && (c = d.getAnchor([{}], a), d.updatePosition({
                    plotX: c[0],
                    plotY: c[1]
                }));
        ...
        reset: function(a, b) {
            ...
            if (a) g && h && (g.refresh(h), e && (e.setState(e.state, !0), o(c.axes, function(a) {
                ...
                if (d) d.onMouseOut();
                g && g.hide(b);
                if (this._onDocumentMouseMove) V(A, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                o(c.axes, function(a) {
                    a.hideCrosshair()
                });
        ...
        onContainerMouseMove: function(a) {
            var b = this.chart;
            if (!r(ga) ||
                !O[ga] || !O[ga].mouseIsDown) ga = b.index;
            a = this.normalize(a);
            a.returnValue = !1;
        ...
        touch: function(a, b) {
            ...
            if (a.touches.length ===
                ...
                if (a = this.normalize(a), c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu) {
                    ...
                    if (a.type === "touchmove") c = this.pinchDown, d = Math.sqrt(Math.pow(c[0].chartX - a.chartX, 2) + Math.pow(c[0].chartY - a.chartY, 2)) >= 4;
                    p(d, !0) && this.pinch(a)
                } else b && this.reset();
    ...
    if (C.PointerEvent ||
        ...
        var va = {},
            ...
            Db = function(a, b, c, d) {
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && O[ga]) d(a), d = O[ga].pointer, d[b]({
                    type: c,
    ...
    pb.prototype = {
        init: function(a, b) {
            var c = this,
                ...
                e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = D(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), N(c.chart, "endResize", function() {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (k in i.stroke = h, g = a.convertAttribs(g), g) d = g[k], d !== z && (i[k] = d);
                f.attr(i)
            }
        },
        ...
        renderItem: function(a) {
            ...
            this.setText(a);
            c = o.getBBox();
            f = a.checkboxOffset = d.itemWidth || a.legendItemWidth || f + g + c.width + j + (x ? 20 :
                0);
            this.itemHeight = g = B(a.legendItemHeight || c.height);
            if (e && this.itemX - v + f > (m || b.chartWidth - 2 * k - v - d.x)) this.itemX = v, this.itemY += q + this.lastLineHeight + n, this.lastLineHeight = 0;
            ...
            if (a > f && k.enabled !== !1) {
                ...
                o(y, function(a, b) {
                    var c = a._legendItemPos[1],
                        ...
                        e = n.length;
                    if (!e || c - n[e - 1] > h && (v || c) !== n[e - 1]) n.push(v || c), e++;
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                k = this.padding;
            e > d && (e = d);
            if (e > 0) b !== z && Ta(b, this.chart), this.nav.attr({
                translateX: k,
    ...
    (/Trident\/7\.0/.test(za) || La) && fb(pb.prototype, "positionItem", function(a, b) {
        var c = this,
            d = function() {
    ...
    gb.prototype = {
        ...
        getArgs: function() {
            var a = [].slice.call(arguments);
            if (xa(a[0]) || a[0].nodeName) this.renderTo =
                a.shift();
            this.init(a[0], a[1])
        },
        init: function(a, b) {
        ...
        cloneRenderTo: function(a) {
            ...
            a ? b && (this.renderTo.appendChild(c),
                Sa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), L(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
        ...
        setSize: function(a, b, c) {
            ...
            if (r(a)) d.chartWidth = e = t(0, B(a)), d.hasUserSize = !!e;
    ...
    R.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ma(j)) {
                        ...
                        for (c = 0; c < h; c++) q[c] = m, v[c] = a[c], m += j;
                        e.xIncrement = m
                    } else if (Da(j))
                        if (y)
                            for (c = 0; c < h; c++) j = a[c], q[c] = j[0], v[c] = j.slice(1, y + 1);
                        else
                            for (c = 0; c < h; c++) j = a[c], q[c] = j[0], v[c] = j[1];
                    else Z(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== z && (j = {
        ...
        processData: function(a) {
            ...
            for (i = b.length || 1; --i;) d = m ? k(b[i]) - k(b[i - 1]) : b[i] - b[i - 1], d > 0 && (g === z || d < g) ? g = d : d < 0 && this.requireSorting && Z(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        getExtremes: function(a) {
            ...
            for (l = 0; l < d; l++)
                if (k =
                    c[l], j = a[l], i = j !== null && j !== z && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)
                    if (i = j.length)
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i ===
                ...
                if (e.isLog && u !== null && u <= 0) s.y = u = null, Z(10);
                s.plotX = m = E(t(-1E5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
                if (b && this.visible && !s.isNull && w && w[x]) o = this.getStackIndicator(o, x, this.index), w = w[x], u = w.points[o.key], n = u[0], u = u[1], n === l && (n = p(j, e.min)), e.isLog && n <= 0 && (n = null), s.total = s.stackTotal = w.total,
                    s.percentage = w.total && s.y / w.total * 100, s.stackY = u, w.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                m = this.pointAttr[""],
                n, q, o, y = this.markerGroup,
                r = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, q = !!g.marker, a = r && n.enabled === z || n.enabled, o = g.isInside, a && e !== z && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") ===
                            0, j) j[o ? "show" : "hide"](!0).attr(a).animate(s({
                            x: d - h,
                            y: e - h
                        }, j.symbolName ? {
                            width: 2 * h,
        ...
        getAttribs: function() {
            ...
            if (!j || g < j || k)
                for (; g--;) {
                    ...
                    if (j.options)
                        for (t in m) r(c[m[t]]) && (k = !0);
                    if (k) {
                        c = c || {};
                        k = [];
                        d = c.states || {};
                        f = d.hover = d.hover || {};
                        if (!b.marker || j.negative && !f.fillColor && !e.fillColor) f[a.pointAttrToOptions.fill] = f.color || !j.options.color && e[j.negative && h ?
                            "negativeColor" : "color"] || ja(j.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: j.color
                        };
        ...
        drawGraph: function() {
            ...
            o(c, function(c, i) {
                ...
                if (j) j.animate({
                    ...
                    fill: g,
                    zIndex: 1
                }, c[2] ? j.dashstyle = c[2] : e && (j["stroke-linecap"] = j["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(f).attr(j).add(a.group).shadow(i <
                    2 && b.shadow)
            })
        },
        applyZones: function() {
        ...
        buildKDTree: function() {
            function a(c, e, f) {
                var g, h;
                if (h = c && c.length) return g =
                    b.kdAxisArray[e % f], c.sort(function(a, b) {
                        return a[g] - b[g]
                    }), h = Math.floor(h / 2), {
                        point: c[h],
    ...
    R.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !==
            ...
            for (x = 0; x < d; x++) {
                ...
                y = (o = j && s < (g ? 0 : f)) ? k : i;
                m[y] || (m[y] = {});
                if (!m[y][u]) n[y] && n[y][u] ? (m[y][u] = n[y][u], m[y][u].total = null) : m[y][u] = new Jb(l,
                    l.options.stackLabels, o, u, h);
                y = m[y][u];
                if (s !== null) y.points[r] = y.points[this.index] = [p(y.cum, g)], y.touched = l.stacksTouched, q.index > 0 && this.singleStacks === !1 && (y.points[r][0] = y.points[this.index + "," + u + ",0"][0]);
                ...
                y.cum = p(y.cum, g) + (s || 0);
                if (s !== null) y.points[r].push(y.cum), c[x] = y.cum
            }
    ...
    R.prototype.setPercentStacks = function() {
        ...
        o([b, "-" + b], function(b) {
            ...
            for (var g = d.length, h, i; g--;)
                if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = da(h[0] * i), h[1] = da(h[1] * i), a.stackedYData[g] = h[1]
        })
    };
    ...
    var la = oa(R, {
                ...
                o(b, function(g, i) {
                    ...
                    if (f[g] && !f[g].isNull) a.push(f[g]), o([-1, 1], function(a) {
                        var c = a === 1 ? "rightNull" : "leftNull",
                            ...
                            n = e[b[i + a]];
                        if (n)
                            for (m = h; m >= 0 && m < k;) p = n.points[m], p || (m === h ? f[g][c] = !0 : j[m] && (r = e[g].points[m]) && (d -= r[1] - r[0])), m += l;
        ...
        getGraphPath: function(a) {
            ...
            for (f = 0; f < a.length; f++)
                if (g = a[f].isNull, j = p(a[f].rectPlotX, a[f].plotX), q = p(a[f].yBottom, n), !g || c) {
                    c || o(f, f - 1, "left");
    ...
    wa = oa(R, {
        ...
        translate: function() {
            ...
            o(a.points, function(c) {
                ...
                c.tooltipPos = b.inverted ? [e.len +
                    e.pos - b.plotLeft - h, a.xAxis.len - o - r / 2, x
                ] : [o + r / 2, h + e.pos - b.plotTop, x];
                c.shapeType = "rect";
        ...
        drawPoints: function() {
            ...
            o(a.points, function(h) {
                var i = h.plotY,
                    k = h.graphic;
                if (i !== z && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = r(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? (Na(k), k.attr(i).attr(g)[b.pointCount <
                    e ? "animate" : "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
    ...
    R.prototype.drawDataLabels = function() {
        var a = this,
            ...
            i, k, j = p(d.defer, !0),
            l = a.chart.renderer;
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden" :
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (n) d = s({
            ...
            width: k.width,
            height: k.height
        }), l ? (o = !1, g = f.renderer.rotCorr(j,
            l), g = {
            x: d.x + c.x + d.width / 2 + g.x,
            y: d.y + c.y + d.height / 2
        }, b[e ? "attr" : "animate"](g).attr({
            align: c.align
        }), h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? k.height : 0 : m === "center" ? (g.x -= k.width / 2, g.y -= k.height / 2) : m === "right" && (g.x -= k.width, g.y -= h ? 0 : k.height)) : (b.align(c, null, d), g = b.alignAttr), o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape && !l && b.attr({
            anchorX: a.plotX,
            anchorY: a.plotY
        });
        if (!n) Na(b), b.attr({
    ...
    if (I.pie) I.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            o(b, function(a) {
                if (a.dataLabel && a.visible) z[a.half].push(a), a.dataLabel._pos = null
            });
            for (F = 2; F--;) {
                var H = [],
                    N = [],
                ...
                if (M) {
                    ...
                    if (m > 0) {
                        ...
                        for (J = 0; J < M; J++) {
                            ...
                            c = 9999;
                            var P, O;
                            for (O = 0; O < x; O++) P = Q(H[O] - u[1]), P < c && (c = P, K = O);
                            if (K < J && H[J] !== null) K = J;
                            else
                                for (x < M - J + K && H[J] !== null && (K = x - M + J); H[K] === null;) K++;
                            N.push({
                                i: K,
                                y: H[K]
                            });
                    ...
                    for (J =
                        ...
                        w.connX = A;
                        w.connY = C;
                        if (this.options.size === null) x = w.width, A - x < f ? G[3] = t(B(x - A + f), G[3]) : A + x > h - f && (G[1] = t(B(A + x - h + f), G[1])), C - b / 2 < 0 ? G[0] = t(B(-C + b / 2), G[0]) :
            ...
            if (Fa(G) === 0 || this.verifyDataLabelOverflow(G)) this.placeDataLabels(), s && g && o(this.points, function(b) {
                k = b.connector;
                u = b.labelPos;
                if ((w = b.dataLabel) && w._pos && b.visible) D = w._attr.visibility, A = w.connX, C = w.connY, j = l ? ["M", A + (u[6] === "left" ? 5 : -5), C, "C", A, C, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), C, "L", u[2], u[3], "L", u[4], u[5]], k ? (k.animate({
                    d: j
    ...
    }, I.pie.prototype.alignDataLabel = Aa, I.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
            c = this.options,
            d = c.center,
            e = c.minSize || 80,
    ...
    (function(a) {
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (e = 0; e < b; e++) {
                k = a[e];
                for (d = e + 1; d < b; ++d)
                    if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (l = k.alignAttr, m = j.alignAttr, n = k.parentGroup, o = j.parentGroup, p = 2 * (k.box ? 0 : k.padding), l = !(m.x + o.translateX > l.x + n.translateX + (k.width - p) || m.x + o.translateX + (j.width - p) < l.x + n.translateX || m.y + o.translateY > l.y + n.translateY + (k.height - p) || m.y + o.translateY + (j.height - p) < l.y + n.translateY)))(k.labelrank < j.labelrank ? k : j).newOpacity = 0
            }
            c(a, function(a) {
                var b, c;
                if (a) {
    ...
    ea = w.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            if (e && !c)
                for (j =
                    e + 1; j--;) d[j] === "M" && d.splice(j + 1, 0, d[j + 1] - i, d[j + 2], "L"), (j && d[j] === "M" || j === e) && d.splice(j, 0, "L", d[j - 2] + i, d[j - 1]);
            k ? k.attr({
                d: d
    ...
    s(R.prototype, {
        ...
        setVisible: function(a, b) {
            var c = this,
                ...
                h = c.visible;
            f = (c.visible = a = c.userOptions.visible = a === z ? !h : a) ? "show" :
                "hide";

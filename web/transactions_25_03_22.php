	...
	<div class="container-fluid main-content new_dpt_bottom">
						...
						<form id="grn_details"  class="form-horizontal"  enctype="multipart/form-data">
							...
							<legend>GRN Information</legend>
								<div class="row">
									...
									<div class="form-group">
										...
										?>
										<input type="text" id="grn_no" <?php  if($_SESSION['role']=="CL") echo 'value="Ex.GE/0000031" disabled'  ?> required name="grn_no" minlength="6" maxlength="6" class="form-control" />
										<?php 
										}
										?>
							...
							<legend>Consignor & Consignee Information</legend>
								...
								<div class="col-md-offset-1 col-md-5">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="address1" name="address1" value="<?php echo $row['address1']; ?>" class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4">Address 2 <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<input type="text" id="address2" name="address2" value="<?php echo $row['address2']; ?>" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-8">
											<select name="state" id="state" class="form-control">
												...
												<?php 
													...
													{
												?>
												<option value="<?php echo $state_row['state_id']; ?>" <?php if($state_row['state_id']==$row['state']) echo "selected"; ?>><?php echo $state_row['state_name']; ?></option>
												<?php
													}
												?>
											</select>
										...
										<div class="col-lg-8">
											<select name="city" id="city" class="form-control">
												...
												<?php 
													...
													{
												?>
												<option value="<?php echo $city_row['city_id']; ?>" <?php if($city_row['city_id']==$row['city']) echo "selected"; ?>><?php echo $city_row['city_name']; ?></option>
												<?php
													}
												?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="pincode" value="<?php echo $row['pincode']; ?>" name="pincode" class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="gst_no" name="gst_no" value="<?php echo $row['gst_no']; ?>" class="form-control" required/>
										</div>
									</div>
								</div>
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<div class="col-lg-8">
											...
											<input name="consignee" id="consignee"  type="hidden" value="<?php echo $row['consignee']; ?>" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4">Address 1 <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<input type="text" id="con_address1" value="<?php echo $row['con_address1']; ?>" name="con_address1" class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4">Address 2 <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<input type="text" id="con_address2" name="con_address2"  value="<?php echo $row['con_address2']; ?>" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4">State <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<select name="con_state" id="con_state" class="form-control">
												<option value="">Select State</option>
												<?php 
													$state_query ="select * from state where status=0";
													$state_result = mysqli_query($conn,$state_query);
													...
													{
												?>
												<option value="<?php echo $state_row['state_id']; ?>" <?php if($state_row['state_id']==$row['con_state']) echo "selected"; ?>><?php echo $state_row['state_name']; ?></option>
												<?php
													}
												?>
											</select>
										...
										<div class="col-lg-8">
											<select name="con_city" id="con_city" class="form-control">
												...
												<?php 
													...
													{
												?>
												<option value="<?php echo $city_row['city_id']; ?>"  <?php if($city_row['city_id'] == $row['con_city']) echo "selected"; ?>><?php echo $city_row['city_name']; ?></option>
												<?php
													}
												?>
											</select>
									...
									<div class="form-group">
										<label class="control-label col-sm-4">Pincode <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<input type="text" id="con_pincode" name="con_pincode" value="<?php echo $row['con_pincode']; ?>" class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4">Phone <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<input type="text" id="con_phone" name="con_phone" value="<?php echo $row['con_phone']; ?>" class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4">GST No <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
											<input type="text" id="con_gst" name="con_gst"  value="<?php echo $row['con_gst_no']; ?>" class="form-control" required/>
										</div>
									</div>
								</div>
							...
							<legend>Package Information</legend>
								...
								?>
									...
									<td><input type="text" name="party_invoice[]" id="party_invoice<?php echo $i; ?>" class="form-control"></td>
									<td><input type="text" name="content[]" id="content<?php echo $i; ?>" class="form-control"></td>
									<td><input type="text" name="qty[]" id="qty<?php echo $i; ?>" class="form-control num_only text-right"></td>
									<td><input type="text" name="gross[]" id="gross<?php echo $i; ?>" class="form-control  text-right num_only"></td>
									<td><input type="text" name="charged[]" id="charged<?php echo $i; ?>" class="form-control  text-right num_only"></td>
									</tr>
								<?php 
									}
								...
								?>
									...
									<td><input type="text" name="no_of_pkg[]" value="<?php echo $invoice_row['no_of_pkge']; ?>" id="no_of_pkg<?php echo $j; ?>" class="form-control  text-right num_only"></td>
									<td><input type="text" name="type_of_pkg[]" value="<?php echo $invoice_row['type_of_pkge']; ?>" id="type_of_pkg<?php echo $j; ?>" class="form-control"></td>
									...
									<td><input type="text" name="qty[]" value="<?php echo $invoice_row['qty']; ?>"  id="qty<?php echo $j; ?>" class="form-control num_only text-right"></td>
									<td><input type="text" name="gross[]" value="<?php echo $invoice_row['gross_weight']; ?>"  id="gross<?php echo $j; ?>" class="form-control text-right num_only"></td>
									<td><input type="text" name="charged[]" value="<?php echo $invoice_row['charged_weight']; ?>" id="charged<?php echo $j; ?>" class="form-control text-right num_only"></td>
									</tr>
								<?php 
								$j++;
							...
							<legend>Volumetric Consignment(If Any)</legend>
								...
								<!--	<div class="form-group">
										<label class="control-label col-sm-4">Octroi will be paid by:</label>
										<div class="col-lg-8">
											<input type="text" id="octroi" name="octroi" value="<?php echo $row['octroi'] ?>" class="form-control" />
										</div>
									</div> -->
					 ...
					 <div class="row">
						<div class="col-md-offset-1 col-md-5">
							<div class="form-group">
								...
								<div class="col-lg-8">
									<select type="text" name="vehicle_no" id="vehicle_no" value="<?php echo $row['truck']; ?>" class="form-control" >
				...
				<div class="col-md-5">
						...
						?>
								<div class="col-sm-6">
									...
									<div class="col-sm-2">
										<img src="images/<?php echo $transaction_image_row['attachment'];  ?>" class="image_preview"  id="image_preview<?php echo $k; ?>" >
									</div>
		...
		if(role=="CL")
		{
				...
				$.ajax({
					...
					success:function(result){
						console.log(result);
						 $("#origin").val(result['city']).change(); 
						setTimeout(function(){ $("#consignor").val(result['company_id']).change(); }, 300);
		...
		$(document).on('keyup','#consignor_name',function(){
				...
				$("#consignor_name").autocomplete({
					...
					type:"GET",
					dataType:"JSON",
					data:{cmd:"get_client_details",tbl_id:ui.item.id},
					async:false,
					success:function(result){
						console.log(result);
						if($('#origin').val()=="")
		...
		$(document).on('keyup','#consignee_name',function(){
				...
				$("#consignee_name").autocomplete({
					...
					success:function(result){
						...
						$('#con_pincode').val(result['pincode']);
	...
	//alert(data1);
		...
		$(document).on('change','.filestyle',function(){
			...
			$(document).on('click', '#add_more', function(evt){
				...
				//alert($file_no);
				$new_file = '<br/><div class="col-sm-12 file-group" id="file-no'+$file_no+'" data-file-no="'+$file_no+'" style="margin-top:58px;margin-left: -4px;">\
								<div class="col-sm-6">\

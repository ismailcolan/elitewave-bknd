...
<body class="page-header-fixed bg-1">
                ...
                <div class="col-md-offset-1 col-md-10">
                    <div class="widget-container fluid-height clearfix">
                        ...
                        <div class="widget-content padded">
                            ...
                            $transaction_id = $row['user_id'];
                            $consingee_email = $row['consignee_email'];
                            $shipp =  $row['shipping_address'] ? $row['shipping_address'] : null;
                            if ($row['user_id'] > 0) $form_name = "add_new_user_consignment";
                            else $form_name = "edit_user_consignment_form";
                            ...
                            <form id="grn_details" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="edit_id" id="edit_id" value="<?php echo $row['user_id']; ?>">
                                        ...
                                        <div class="col-md-offset-1 col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <?php
                                                    $users = mysqli_query($conn, "select *from users where user_id = '$transaction_id'");
                                                    $user_email = mysqli_fetch_assoc($users);
                                                    $email = $user_email['email'];
                                                    $clients = array();
                                                    $query_client = mysqli_query($conn, "select *from client where email IN('$email','$consingee_email')");
                                                    while ($query_client_id = mysqli_fetch_assoc($query_client)) {
                                                        $clients[] = $query_client_id['client_id'];
                                                    }
                                                    // print_r($clients);
                                                    // exit();
                                                    $client_id = $clients[0];
                                                    $client_id2 = $clients[1];
                                                    //var_dump($client_id);
                                                    ...
                                                    if ($grn_no != '') {
                                                    ?>
                                                        <input type="text" id="grn_no" name="grn_no" value="<?php echo $grn_no; ?>" class="form-control" readonly />
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <input type="text" id="grn_no" name="grn_no" value="<?php echo $grn_no; ?>" class="form-control" readonly />
                                                        <input type="text" id="grn_no1" name="grn_no1" class="form-control" readonly />
                                                    <?php
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group date date-picker table-height" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
                                                        <input class="form-control table-height final" type="text" name="grn_date" value="<?php if ($row['created_at'] != '')
                                                                                                                                                echo $row['created_at'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <select name="mode_of_trasport" id="mode_of_trasport" class="form-control" required onchange="handleSelectChange(event);">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $transport_row['mode_id']; ?>" <?php if ($transport_row['mode_id'] == $row['shipping_mode']) echo "selected"; ?>><?php echo $transport_row['mode_type']; ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="origin" id="origin" class="form-control" required>
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $city_row['city_id']; ?>" <?php if ($city_row['city_id'] == $row['consignor_city']) echo "selected"; ?>><?php echo $city_row['city_name']; ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="destination" id="destination" class="form-control" required>
                                                        ...
                                                        $city_query1 = "select * from city where status=0 and city_id!='" . $row['consignor_city'] . "' order by city_name asc";
                                                        $city_result1 = mysqli_query($conn, $city_query1);
                                                        while ($city_row1 = mysqli_fetch_array($city_result1)) {
                                                        ?>
                                                            <option value="<?php echo $city_row1['city_id']; ?>" <?php if ($city_row1['city_id'] == $row['consignee_city']) echo "selected"; ?>><?php echo $city_row1['city_name']; ?></option>
                                                        <?php
                                                        }
                                                        //	}
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="mode_of_consignment" id="mode_of_consignment" class="form-control" required>
                                                        ...
                                                        ?>
                                                                <option value="<?php echo $consignment_row['consignment_id']; ?>" <?php if ($consignment_row['consignment_id'] == $row['pay_mode']) echo "selected"; ?>><?php echo $consignment_row['consignment_mode']; ?></option>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" name="consignor_name" class="form-control" required id="consignor_name" value="<?php echo $row['consignor_name']; ?>" autocomplete="off" />

                                                    <input name="consignor" id="consignor" required value="<?php echo $r_code['client_id']; ?>" type="hidden" />
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" name="consignee_name" class="form-control" required id="consignee_name" value="<?php echo $row['consignee_name']; ?>" autocomplete="off" />


                                                    <input name="consignee" id="consignee" required value="<?php echo $r_code['client_id']; ?>" type="hidden" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-offset-1 col-md-10">
                                            <table class="table table-bordered tabs" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" name="party_invoice[]" id="party_invoice<?php echo $i; ?>" class="form-control" onchange="party_invoice_details();" onkeyup="party_invoice_details();" autocomplete="off"></td>
                                                ...
                                                ?>
                                                    <tbody>
                                                        <?php
                                                        $invoice_query = "select * from user_inquiry_list where md5(`user_id`) = '" . $_REQUEST['key'] . "'";
                                                        $invoice_result = mysqli_query($conn, $query);
                                                        $j = 1;
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td id="pkg_req"><input type="text" name="no_of_pkg[]" value="<?php echo $invoice_row['no_of_package']; ?>" id="no_of_pkg<?php echo $j; ?>" class="form-control  text-right num_only"></td>
                                                                <td>
                                                                    <select type="text" name="type_of_pkg[]" id="type_of_pkg<?php echo $i; ?>" class="form-control">
                                                                        ...
                                                                        while ($pkg_r = mysqli_fetch_array($pkg_type_q)) {
                                                                        ?>
                                                                            <option value="<?php echo $pkg_r['package_id']; ?>" <?php if ($invoice_row['type_of_package'] == $pkg_r['package_id']) echo "selected"; ?>><?php echo $pkg_r['package_code']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                                </td>
                                                                <td id="inv_req"><input type="text" name="party_invoice[]" value="<?php echo $invoice_row['invoice_no']; ?>" id="party_invoice<?php echo $j; ?>" class="form-control" inputmode="numeric" autocomplete="off" onpaste="return false;" value="<?php echo $invoice_row['invoice_no']; ?>" id="party_invoice<?php echo $j; ?>" class="form-control" onchange="party_invoice_details();" onkeyup="party_invoice_details();"></td>
                                                        ...
                                                        ?>
                                                        <!-- <td><input type="text" name="cumulative_charged" id="cumulative_charged" class="form-control  text-right num_only" onchange="calculate_rate();"></td> -->
                                                    </tbody>
                                                <?php
                                                }
                                                ?>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-5">
                                        ...
                                        <fieldset class="my-fieldset">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-4 v_label">E-Way Expiry Date:</label>
                                                <div class="col-lg-8">
                                                    <div class="input-group date date-picker table-height" data-date-autoclose="true" data-date-format="dd-mm-yyyy">
                                                        <input type="text" id="eway_expiryDate" name="eway_expiryDate" class="form-control text-right" value="<?php echo $row['eway_expirydate'] ?>" />
                                            ...
                                            <div class="form-group kl">
                                                ...
                                                <div class="df col-lg-8">
                                                    <?php
                                                    $length = $row['length'];
                                                    $length_dimension1 = explode(',', $length);
                                                    $width = $row['width'];
                                                    $width_dimension2 = explode(',', $width);
                                                    $height = $row['height'];
                                                    $height_dimension3 = explode(',', $height);
                                                    $quantity = $row['quantity'];
                                                    $quantity_dimension4 = explode(',', $quantity);
                                                    $count = 0;
                                                    ...
                                                    ?>
                                                        <div class="form-group dimensions_col" id="dimensions_col">
                                                            <div class="volumetric_width">
                                                                <input type="text" placeholder="L" class="form-control r_p length num_only " id="length" name="length[]" onchange="vlm_calculation();" value="<?php echo $length_dimension1[$key] ?>" /><span>X</span>
                                                            </div>
                                                            <div class="volumetric_width">
                                                                <input type="text" placeholder="w" class="form-control r_p width  num_only" id="width" name="width[]" onchange="vlm_calculation();" value="<?php echo $width_dimension2[$key]; ?>" /><span>X</span>
                                                            </div>
                                                            <div class="volumetric_width">
                                                                <input type="text" placeholder="H" class="form-control r_p height num_only" id="height" name="height[]" onchange="vlm_calculation();" value="<?php echo $height_dimension3[$key]; ?>" /><span>X</span>
                                                            </div>
                                                            <div class="volumetric_width">
                                                                <input type="text" placeholder="Q" class="form-control r_p quantity num_only" id="quantity" name="quantity[]" onchange="vlm_calculation();" value="<?php echo $quantity_dimension4[$key]; ?>" /><span>=</span>
                                                            </div>
                                                            <div class="volumetric_width">
                                                                <input type="text" placeholder="" class="form-control r_p weight num_only" id="weight " name="weight[]" onchange="vlm_calculation();" />
                                                            </div>
                                                            <div class="volumetric_width">
                                                                <input type="text" class="form-control  r_p  volume_weight num_only" id="volume_weight" name="volume_weight[]" onchange="vlm_calculation();" />
                                                            </div>
                                                ...
                                                <div class="vlm_total_val">
                                                    <input type="text" placeholder="" class="form-control r_p v_weight" id="v_weight" name="v_weight[]" onchange="vlm_calculation();" />
                                                </div>
                                            </div>
                                        ...
                                        <fieldset class="my-fieldset">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Freight</td>
                                                        <td><input type="text" name="frieght_rate" id="frieght_rate" value="<?php echo $row['frieght_rate']; ?>" class="form-control text-right" onchange="calculate_rate();" autocomplete="off"/></td>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="file-container">
                                                <div class="col-md-12 file-group" id="file-no1" data-file-no="1">
                                                    <div class="col-md-6">
                                                        <input type="file" id="file_receipt1" name="file_receipt[]" class="filestyle" data-id="1" data-buttonBefore="true" data-buttonName="btn-primary" required>
                                                    </div>
                                    ...
                                    ?>
                                        <div class="col-md-5">
                                            ...
                                            <div class="file-container">
                                                ...
                                                <?php
                                                $transaction_image_query = "select * from user_inquiry_list where md5(`user_id`) = '" . $_REQUEST['key'] . "'";
                                                ...
                                                while ($transaction_image_row = mysqli_fetch_array($transaction_image_result)) {
                                                    ...
                                                    $image = $transaction_image_row['attchment'];


                                                ?>
                                                    <div class="col-md-12 file-group" id="file-no<?php echo $k; ?>" data-file-no="<?php echo $k; ?>">
                                                        <div class="col-md-6">
                                                            <input type="file" id="file_receipt<?php echo $k; ?>" name="file_receipt" class="filestyle" data-id="<?php echo $k; ?>" data-buttonBefore="true" data-buttonName="btn-primary" value="<?php echo $image; ?>">
                                                        </div>

                                                        <div class="col-md-2">
                                                            <img src="invoice_image/<?php echo $transaction_image_row['attchment'];  ?>" class="image_preview" id="image_preview<?php echo $k; ?>">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <!-- <button data-id="<?php echo $k; ?>" id="<?php echo $transaction_image_row['attchment'];  ?>" class="btn btn-danger remove-image" type="button">Remove</button> -->
                                                        </div>
                                                    </div>
                                                <?php
                                                }
                        ...
                        <div class="row">
                            <div class="col-md-12 form-action">
                                ...
                                <a class="btn btn-default-outline  btn-reset btn-cancel" type="button" href="user-inquiry.php">Cancel</a>
    ...
    <script type="text/javascript">
        //Auto Calculation Part Start
        var get_train_type = 0;
        ...
        if (transportMode === '1' || transportMode === '3') {
            gst = 18;
        ...
        function party_invoice_details() {
            //alert("Test Invoice");
            console.log("Test OLd2,", load_party_inv);
            ...
            if (conr_id != "" && conr_id != null) {
                ...
                $.ajax({
                    ...
                    success: function(result_data) {
                        ...
                        if (form_name == "edit_new_user_consignment") {
                            console.log(all_party_invoice);
                            if (result_data) {
                                // console.log(result_data);
                                $.each(result_data, function(index, value) {
                                    ...
                                    if ($.inArray($.trim(all_party_invoice[index]), load_party_inv) == -1) {
                                        ...
                                        if (value == "EMPTY") {
                                            $(party_invoice).css("border", "1px solid #8E8D8D");
                                        } else if (value == "NO") {
                                            $(party_invoice).css("border", "1px solid #00CB01");
                                        } else {
                                            $(party_invoice).css("border", "1px solid #e71717");
                                        }
                                    } else {
                            ...
                            if (result_data) {
                                ...
                                $.each(result_data, function(index, value) {
                                    ...
                                    var adddd = index + 1;
                                    var party_invoice = '#party_invoice' + adddd;
                                    //var party_invoice_valid = '#party_invoice_valid' + adddd;
                                    ...
                                    if (value == "EMPTY") {
                                        ...
                                        //$(party_invoice_valid).val(0);
                                    } else if (value == "NO") {
                                        // $(party_invoice).css("border", "1px solid #00CB01");
                                        $(party_invoice).removeClass("invoice_exist invoice_new").addClass("invoice_valid");

                                        //$(party_invoice_valid).val('Not');
                                    } else {
                                        //$(party_invoice).addClass('invoice_exist');
        ...
        function vlm_calculation() {
            ...
            function get_all_total(array_data) {
                ...
                //$('#charged1').val(total_weight.toFixed(0));
                calc_charge_amt();
                calculate_charge_weight();
            }
        }
        ...
        $(document).ready(function() {
            ...
            //Get Consignor and Consignee ID
            var selected_consignor_id = $('#consignor').val();
            if (selected_consignor_id != null && selected_consignor_id != '') {
                party_invoice_details();
            }
            ...
            if (edit_form == 'add_new_user_consignment') {
            ...
            if ($('#consignor').val() != '' && $('#consignee').val() != '') {
            ...
            $(document).on('click', '#save', function() {
                ...
                if ($('#grn_details').valid() == true && chck_key == true) {
                    ...
                    // console.log('Party Invoice Exist',party_invoice_validate.length);
                    // return;
                    var consignor_id = $('#consignor').val();

    ...
    <div class="col-lg-8">
        <label class="control-label" id="address"></label>
								...
								<div class="col-md-5">
									...
									<label class="control-label" id="con_address"></label>
									<div class="form-group">
										<label class="control-label col-sm-4">State <span style="color:red;">*</span> :</label>
										<div class="col-lg-8">
				...
				<div class="col-md-5">
						...
						<div class="col-md-12 file-group" id="file-no<?php echo $k; ?>" data-file-no="<?php echo $k; ?>">
								<div class="col-md-6">
									...
									<div class="col-md-2">
										<img src="eway/<?php echo $transaction_image_row['attachment'];  ?>" class="image_preview"  id="image_preview<?php echo $k; ?>" >
									</div>
								<div class="col-md-2">
...
$('#address').html(address);
			...
			$.ajax({
			    async:false,
					...
					success:function(result){
					ewToast(result['destination'], 'info');
				setTimeout(function(){ 

...
<body class="page-header-fixed bg-1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" name="no_of_pkg[]" value="<?php echo $invoice_row['no_of_package']; ?>" id="no_of_pkg<?php echo $j; ?>" class="form-control  text-right num_only"></td>
                                                                <td>
                                    ...
                                    <div class="col-md-offset-1 col-md-5">
                                        ...
                                        <fieldset class="my-fieldset">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" id="dimension1" name="dimension1" value="<?php echo $row['length']; ?>" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4"></label>
                                                <div class="col-lg-8">
                                                    <input type="text" id="dimension2" name="dimension2" value="<?php echo $row['width']; ?>" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4"></label>
                                                <div class="col-lg-8">
                                                    <input type="text" id="dimension3" name="dimension3" value="<?php echo $row['height']; ?>" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function calculate_rate() {
            //alert("cal")
            var charge_weights = $('#cumulative_charged').val();

            var rates = $("#frieght_rate").val();

            var total_amts = parseInt(rates) * parseInt(charge_weights);
            //console.log("total",total_amt);

			...
			<div class="widget-container fluid-height clearfix">
			  ...
			  <div class="widget-content padded">
				<form class="form-horizontal" id="add_client_form">
					...
					<input type="hidden" id="form_name" name="form_name" value="consignee_to_client">
				...
				<br/>
				 <div class="row">
						...
						//$conn = mysqli_connect("localhost","root","","bookconsignment");
							...
							$consignor_name = $row['consignee_name'];
						...
						?>
							<div class="form-group">
								...
								<input type="text" id="company_name" name="company_name" value="<?php echo $row['consignee_name']; ?>" class="form-control" required/>
							</div>
							<div class="form-group">
								<label class="control-label">Contact Person <span style="color:red;">*</span> :</label>
								<input type="text" name="contact_person" id="contact_person" value="<?php echo $row['consignee_name']; ?>" class="form-control" required/>
								<span class="dup-check"></span>
							</div>
							<div class="form-group">
								<label class="control-label">Address1 <span style="color:red;">*</span> :</label>
								<input type="text" name="address1" id="address1" class="form-control" value="<?php echo $row['consignee_address']; ?>" required/>
								<span class="dup-check"></span>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								?>
								<option value="<?php echo $city_list['city_id'];?>"<?php if($row['consignee_city'] == $city_list['city_id']) echo "selected";?>><?php echo $city_list['city_name'];?></option>
								<?php
								}
								?>	
						...
						<div class="col-md-5">
							...
							<div class="form-group">
								...
								<input type="email" name="email" id="email" value="<?php echo $row['consignee_email']; ?>" class="form-control" required readonly/>
								<span class="email_dup-check"></span>
							</div>
						<div class="form-group">
								<label class="control-label">Contact No <span style="color:red;">*</span> :</label>
								<input type="text" name="contact_no" id="contact_no" value="<?php echo $row['consignee_contact']; ?>" class="form-control" required/>
								<span class="dup-check"></span>
							</div>
			...
			$.ajax({
				...
				success : function(result) {
					...
					if(result[0] == 1){
						...
						$(".email_dup-check").html(result[1]).css("color","#f00");
						dup_chk = false;
					}
					else{
						$(".email_dup-check").html(result[1]).css("color","green");
					}
				},

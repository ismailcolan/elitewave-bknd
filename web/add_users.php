...
$key = $_REQUEST['key'];
// if($key !=''){
// 	$user_query = "SELECT * FROM `user_registrations` WHERE md5(id)='".$key."'";
// 	$user_result = mysqli_query($conn,$user_query);
// 	$user_count = mysqli_num_rows($user_result);
// 	if($user_count == 0){
// 		header('Location:user_registration_request.php');
// 	}
// }
?>
<!DOCTYPE html>
...
<div class="container-fluid main-content new_dpt_bottom">
		  ...
		  <div class="col-md-offset-1 col-md-10">
			<div class="widget-container fluid-height clearfix">
			  ...
			  <div class="widget-content padded">
				...
				<?php 
					$users_query ="SELECT * FROM `user_registrations` WHERE md5(id)='".$key."'";
					$users_result = mysqli_query($conn,$users_query);
					$users_row = mysqli_fetch_array($users_result);
				?> 
					<input type="hidden" id="form_name" name="form_name" value="add_register_user">
				  ...
				  <div class="row">
						...
						<div class="form-group" style="font-size:  16px;">
								...
								<div style="display: none;">
									<input type="radio"  value="GRACIOUS" id="gracious_company" name="company_type" /> Elite Wave 360 User
									<input type="radio"  value="OTHERS" id="other_company" name="company_type" checked> Client Company User
								</div>
						...
						<div class="form-group" id="com_div" style=" <?php if($users_row['company_name']!=0) echo "display:none";  ?> ">
								...
								while($com_r=mysqli_fetch_array($com_q))
								{
									...
									if($users_row['company_name']==$com_r['client_id']) $com_option .='selected';
							...
							<div class="form-group">
								...
								<input type="text" id="user_name" name="user_name" value="<?php echo $users_row['name']; ?>" class="form-control" required autocomplete="off" />
							</div>
							<div class="form-group">
								...
								<select class="form-control" name="role" id="role" >
								  ...
								  <!--<input  name="role" type="radio" value="CL" checked="" id="role" /><span>Client</span></label>
								  <label class="radio radio-inline">
								  <input   name="role" type="radio" value="AD"  id="role" /><span>Admin</span></label>-->
						   </div>
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="password" id="password" name="password" value="<?php echo $users_row['password']; ?>" class="form-control" required autocomplete="off"/>
							</div>
							<div class="form-group">
								<label class="control-label">confirm Password:</label>
								<input type="password" name="confirm_password" id="confirm_password" value="<?php echo $users_row['password']; ?>" class="form-control" autocomplete="off"/>
	 ...
	 $('#gracious_company').click(function () {
        if ($(this).is(':checked')) {
            ...
            $("#com_div").hide(100);
			$("#role").html('<option value="AD">Admin</option><option value="USER">User</option>');
					...
					$.ajax({
						...
						success:function(result){
							...
							if(result == 1){
								...
								location.href = "user-approval.php";
								});
							}
							else
							{

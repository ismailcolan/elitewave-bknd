...
<body>
            ...
            <div class="container">
                ...
                <div class="parent-block">
                    ...
                    <div class="block" id="select-train">
                        ...
                        <div class="row">
                            <div class="dropdown">
                                <select class="sel_train" role="menu" aria-labelledby="menu1" id="sel_train">
                                ...
                                <div class="sub-block" id="form_reload">
                                    <form id="fulldetails">
                                        ...
                                        <div id="sender-details">
                                            ...
                                            <div class="send-rcv-dtl">
                                                <div class="form-group col-sm-6">
                                                    <label for="sender-name" class="required-field">Consignor / Sender Name</label>
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <span class="dup-check-text-status1 p_css boo_p_css"></span>
                                                    <input type="hidden" class="dup-check-status1" value="" />
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="sender-city" class="required-field">City</label>
                                        ...
                                        <div id="package-details" class="disabled">
                                            ...
                                            <div class="send-rcv-dtl ">
                                                <div id="package-info1" class="package-info">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label for="" class="required-field">Invoice No</label>
                                                        <input type="text" class="form-control" name="package-invoice" id="package-invoice" required>
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                                        <label for="" class="required-field">Contents</label>
                                                        <input type="text" class="form-control" name="package-content" id="package-content" required>
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                        ...
                                        <div id="reciever-details" class="disabled">
                                            ...
                                            <div class="send-rcv-dtl ">
                                                <div class="form-group col-sm-6">
                                                    <label for="reciever-name" class="required-field">Consignee / Receiver Name</label>
                                                    <input type="text" class="form-control" name="reciever-name" id="reciever-name" required>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="reciever-contact-no" class="required-field">Contact No:</label>
                                                    <!-- <input  maxlength="10"  pattern="\d{10}" data-rule-maxlength="10"  type="number" class="form-control" name="reciever-contact-no" id="reciever-contact-no" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"> -->
                                                    <input maxlength="10" pattern="\d{10}" data-rule-maxlength="10" type="text" class="form-control" name="reciever-contact-no" id="reciever-contact-no" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>

                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="reciever-email" class="required-field">Email</label>
                                                    <input type="email" class="form-control dup-check" name="reciever-email" id="reciever-email" required>
                                                    <span class="dup-check-text-status p_css boo_p_css"></span>
                                                    <input type="hidden" class="dup-check-status" value="" />
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="reciever-city" class="required-field">City</label>
                                                ...
                                                <div class="form-group col-sm-12  U_ship_address">
                                                    <input type="checkbox" id="ship_adddress" name="user_ship_address" onclick="ship()" value="">
                                                    <label for="sender-area" class="label_ship">Shipping Address</label>

                                                </div>
                                                <div class="form-group col-sm-6" id="shipadd" style="display:none">
                                                    <textarea class="form-control ship_area" rows="4" placeholder="Shipping Address" autocomplete="off" spellcheck="false"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="supporting-document" class="disabled">
                                            ...
                                            <div class="send-rcv-dtl">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <label for="reciever-email" class="required-field">Invoice / D.C Copy</label>
                                                    <input type="file" class="form-control-file" name="exampleFormControlFile1" id="exampleFormControlFile1" required>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //End
            //Check Consginor Email

            $(document).on('input', '#sender-email', function() {
                var chk_key = $(this).val();
                //alert(chk_key);
                if (chk_key != '') {
                    $(".dup-check-text-status1").html('<p style="color:green;"><i class="fa fa-refresh fa-spin"></i> Checking...</p>');
                    $.ajax({
            ...
            $(document).on("click", "#submit", function(e) {
                ...
                console.log(consignoremailCheck);
                if (consignoremailCheck == "1") {

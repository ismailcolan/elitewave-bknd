...
<div class="container">
	<div class="col-md-4">
		<section class="section-contacts-block">
			<h3 class="contacts-block__title ui-title-inner">Gracious Express ('.$branch_row['branch_name'].')</h3>
			...
			<div class="contacts-block clearfix">
				...
				<div class="contacts-block clearfix">
					...
					<span class="contacts-block__inner">
						<a class="contacts-block__emphasis color-primary" href="mailto:info@graciousexpress.com">info@graciousexpress.com.com</a> We usually reply within 24 hours
					</span>
				</div>
			</section>

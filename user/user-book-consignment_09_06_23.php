                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <input type="text" name="get_consignor_id" id="get_consignor_id" value="<?php echo $client_id; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12 cust-padding-margin">
                                    <div class="sub-block" id="form_reload">
                                        <form id="userbookconsignment" enctype="multipart/form-data">
                                            ...
                                            <input type="text" name="train_type" id="train_type" value="" />
                                                ...
                                                <div class="send-rcv-dtl ">
                                                    <div id="package-info1" class="package-info">
                                                        <div class="form-group col-sm-3">
                                                            ...
                                                            <input type="text" class="form-control  user_pack" id="package-qty" name="package-qty[]" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9\.]+/g, '');" onpaste="return false;" autocomplete="off">
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            ...
                                                            <input type="text" class="form-control user_pack" id="invoice" name="invoice[]" data-id="1" onchange="party_invoice_details();" onkeydown="party_invoice_details();" onkeyup="party_invoice_details();" autocomplete="off">
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                        ...
                                                        <div class="form-group col-sm-3">
                                                            ...
                                                            <input type="text" required class="form-control user_pack" id="qty" name="qty[]" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9\.]+/g, '');" onpaste="return false;" autocomplete="off">
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                        ...
                                                        <div class="form-group col-sm-3 charged">
                                                            ...
                                                            <input type="text" class="form-control charged-weight user_pack" id="charged_kg" name="charged_kg[]" onchange="cumulative_charge_wight();" required onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9\.]+/g, '');" onpaste="return false;" autocomplete="off">
                                                    ...
                                                    <div id="wrapper" class="offset-sm-3 col-sm-9">
                                                        <div id="inner1">
                                                            <label for="reciever-area" class="vlm col-sm-4">Declared Value </label>
                                                            <div class="form-group col-sm-6">
                                                                <input style=" margin-bottom : 0;" type="text" name="declared_val" id="declared_val" class="form-control declared-value col-sm-4" onchange="fov_calc();" required>
                                                            </div>
                                                        </div>
                                                        <div id="inner2">
                                                            <label style="" for="reciever-area" class="vlm col-sm-4">E-Way Number </label>
                                                            <div class="form-group col-sm-6">
                                                                <input style=" margin-bottom : 0;" type="text" name="eway_number" id="eway_number" class="form-control eway_number col-sm-4" required>
                                                            </div>
                                                        </div>
                                                        <div id="inner3">
                                                            <label style="" for="reciever-area" class="vlm col-sm-4">E-Way Expiry Date </label>
                                                            <div class="form-group col-sm-6">
                                                                <input style=" margin-bottom : 0;" type="date" name="eway_expiryDate" id="eway_expiryDate" class="form-control col-sm-4 eway_expiry_date" required onchange="getd_date();">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="send-rcv-dtl disabled">
                                                    <div id="volumetric-info1" class="volumetric-info">
                                                        <div class="volumetric-input-boxes">
                                                            ...
                                                            <input type="text" placeholder="Feet/Kgs" class="form-control weight" id="weight" name="weight[]" onchange="calculation();" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" onpaste="return false;" autocomplete="off">
                                                            <input type="hidden" class="form-control volume_weight" id="volume_weight" name="volume_weight[]" />
                                                        </div>

                                                    </div>
                                                    <input type="text" id="reslt" class="form-control reslt" name="reslt" style="width:18%;float: right;">
                                                    <div class="col-sm-12 text-right" id="bc_F">
                    ...
                    success: function(result_data) {
                        ...
                        if (result_data) {
                            $.each(result_data, function(index, value) {
                                var adddd = index + 1;
                                if (value == "EMPTY") {
                                    $('input[data-id=' + adddd + ']').css("border", "1px solid #8E8D8D");
                                } else if (value == "NO") {
                                    $('input[data-id=' + adddd + ']').css("border", "1px solid #00CB01");
                                } else {
                                    $('input[data-id=' + adddd + ']').css("border", "1px solid #e71717");
                                }
                            });
                        } else {

	...
	<script>
        $(document).ready(function(){
            ...
            $('.search').on('keyup',function(e){
                ...
                //alert(user_id);
                //alert(term);
                console.log('../autocomplete.php?autocomplete=get_consigner&user_id='+user_id+'&term='+term);
                $('#consignor').autocomplete({
                    source:'../autocomplete.php?autocomplete=get_consigner&user_id='+user_id+'&term='+term,
                    minLength : 0,
                ...
                $('#consignee').autocomplete({
                    source:'../autocomplete.php?autocomplete=get_username&user_id='+user_id+'&term'+term,
                    minLength : 0,

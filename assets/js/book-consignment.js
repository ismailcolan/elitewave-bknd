...
$('#select-shipping .cust-padding-margin').click(function(){
    ...
    $(this).find('.sub-block').addClass('active');
        // $('.block').removeClass('show')
        let idName = $(this).find('.sub-block').attr('id');
       // let idName = 'by-road-express';
        //console.log(idName);
        if(idName == 'by-road-surface'){
...
$('#select-load .cust-padding-margin').click(function(){
...
$('#select-truck .cust-padding-margin').click(function(){
...
$(document).on('focusout',"#sender-details input",function() {
  ...
  // ON FOCUSOUT FROM SENDER DETAILS INPUT BOX - MOVE TO RECIEVER DETAILS SECTION
$("#package-details input").focusout(function() {

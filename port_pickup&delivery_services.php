...
<html lang="en">
	<head>
		...
		<title>Gracious Express ~ Port Pickup & Delivery Services</title>
			...
			<div class="section-title parallax-bg parallax-light">
				...
				<div class="section__inner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h1 class="ui-title-page">Port Pickup & Delivery Services</h1>
...
<section class="section_mod-e">
				<div class="block-about about_page">
					...
					<h2 class="ui-title-block">Port Pickup & Delivery Services</h2>
					...
					<br>
						<div class="row">
								...
								<div class="block-about__description">
									<p>The delivery of your freight from the destination sea port is the most important leg of the journey. Having a professional logistics partner who is committed to timely pickup and delivery is paramount to your importing business. We value your time and understand the importance of timely delivery and take great pride in getting your freight from port to final destination, by truck, rail or other means within the least possible time.</p>
								</div>
...
<li><i class="fa fa-share" aria-hidden="true"></i> Pickup / Delivery of personal effects and/or household goods</li>
			...
			<br/>
				...
				<div class="col-xs-6 col-md-4">
					<a href="assets/img/pickup-1.jpg" class="thumbnail" title="">
						<img src="assets/img/pickup-1.jpg" alt="">
					</a>
				</div>
				<div class="col-xs-6 col-md-4">
					<a href="assets/img/pickup-2.jpg" class="thumbnail" title="">
						<img src="assets/img/pickup-2.jpg" alt="">
					</a>
				</div>
				<div class="col-xs-6 col-md-4">
					<a href="assets/img/pickup-3.jpg" class="thumbnail" title="">
						<img src="assets/img/pickup-3.jpg" alt="">
					</a>
				</div>

									...
									<form id="fulldetails">
										...
										<div id="sender-details">
											...
											<div class="send-rcv-dtl">
												...
												<div class="form-group col-sm-6">
													<label for="sender-contact-no">Contact No:</label>
													<input type="number" class="form-control" name="sender-contact-no" id="sender-contact-no">
												</div>
												<div class="form-group col-sm-6">
													<label for="sender-email">Email</label>
											...
											<div class="send-rcv-dtl ">
												<div id="package-info1" class="package-info">
													<div class="form-group col-sm-6">
														...
														<input type="text" class="form-control" name="no-of-package" id="no-of-package">
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														...
														<input type="text" class="form-control" name="package-invoice" id="package-invoice">
													</div>
													<div class="form-group col-sm-6">
														<label for="">Contents</label>
														<input type="text" class="form-control" name="package-content" id="package-content">
													</div>
													<div class="form-group col-sm-6">
														<label for="">Quantity </label>
														<input type="text" class="form-control" name="package-qty" id="package-qty">
													</div>
													<div class="form-group col-sm-6">
														<label for="">Gross Wt.(Kgs)</label>
														<input type="text" class="form-control" name="package-gross-wgt" id="package-gross-wgt">
													</div>
													<div class="form-group col-sm-6 charged">
														<label for="">Charged Wt.(Kgs)</label>
														<input type="text" class="form-control charged-weight" name="package-net-wgt" id="package-net-wgt" onchange="ss();">
													</div>
													<div class="form-group col-sm-6 volumetric-info" id="ddd">
														...
														<div class="volumetric-input-boxes disabled">
															...
															<input type="text" class="form-control volume_weight" id="volume_weight" name="volume_weight" onchange="ss();" />
														</div>
														<input type="text" name="final_charged_weight" id="final_charged_weight" />
													</div>
										...
										<div id="reciever-details" class="disabled">
											...
											<div class="send-rcv-dtl ">
												<div class="form-group col-sm-6">
													...
													<input type="text" class="form-control" name="reciever-name" id="reciever-name">
												</div>
												<div class="form-group col-sm-6">
													<label for="reciever-contact-no">Contact No:</label>
													<input  minlength=10 maxlength=10 data-rule- minlength=10 maxlength=10 type="number" class="form-control" name="reciever-contact-no" id="reciever-contact-no" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
												</div>
												<div class="form-group col-sm-6">
													<label for="reciever-email">Email</label>
													<input type="email" class="form-control" name="reciever-email" id="reciever-email">
												</div>
												<div class="form-group col-sm-6">
													<label for="reciever-city">City</label>
													<select name="reciever-city" id="reciever-city" class="form-control">
														<option value="">Select City</option>
														<?php
			...
			function AutoSave() {
				_autosave = setInterval(function() {
					...
					if (sendername != "" && sendercontact != "" && senderemail != "") {
						$.ajax({
							url: 'http://localhost:8080/GraciousExpress/update_details.php',
							type: 'POST',
							data: {

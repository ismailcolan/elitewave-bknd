...
<html lang="en">
	...
	<title>Gracious Express - Rate Calculator</title>
			...
			<div class="section-title parallax-bg parallax-light">
				...
				<div class="section__inner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h1 class="ui-title-page">Rate Calculator</h1>
								<div class="ui-subtitle-page">Find Your Rates</div>
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 ratecal__body__partitions border-right text-center">
                        ...
                        <div class="input-wrapper">
                            <input type="text" placeholder="Destination (city/pincode)" name="destination" id="destination" value="" class="destination search" >
                            <small id = "error-kgs"></small>
                            <div id="autocomplete1" class="autocomplete"></div>
                        </div>
                        <input type="text" placeholder="Weight(in Kgs)" name="kgs" id="kgs" value="">
                        <small id = "error-kgs1"></small>
                    ...
                    <h5 class="">Estimated Tariff</h5>
                        <p>Surface Rate : <span id="surface_rate"> <i class="fas fa-rupee-sign"></i></span></p>
                        <p>Express Rate : <span id="express_rate"><i class="fas fa-rupee-sign"></i></span></p>
                        <p>Train Rate : <span id="train_rate"><i class="fas fa-rupee-sign"></i> </span></p>
                        <p>Air Rate : <span id="air_rate"><i class="fas fa-rupee-sign"></i> </span></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#calculate").click(function(e){
                ...
                $('#error-kgs').text("");
                var message = "Fill KGS Fields";
                $('#error-kgs1').text(message);
                ...
                findBtn.addEventListener('click', () => {
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        dataType:"json",
                        data:{cmd:"get_rate_form",origin:origin,destination:destination,kgs:kgs},
                        success:function(data){
                            //console.log(data);
                            $("#estimation").show();
                            $("#surface_rate").html("<i class='fa fa-inr'> " + data.surface + "</i>");
                            $("#express_rate").html("<i class='fa fa-inr'> " + data.express + "</i>");
                            $("#train_rate").html("<i class='fa fa-inr'> " + data.train + "</i>");
                            $("#air_rate").html("<i class='fa fa-inr'> " + data.air + "</i>");
            ...
            $(".search").on('keyup',function(){
                var term = $(this).val();
                console.log("http://localhost/graciousexpress/autocomplete.php?autocomplete=get_origin_pincode&term="+term);
                $("#origin").autocomplete({
                    source:"http://localhost/graciousexpress/autocomplete.php?autocomplete=get_origin_pincode&term="+term,
                    minLength : 0,
                ...
                $("#destination").autocomplete({
                    source:"http://localhost/graciousexpress/autocomplete.php?autocomplete=get_destination_pincode&term="+term,
                    minLength : 0,

...
<html lang="en">
	<head>
		...
		<title>Gracious Express ~ Express Cargo Services</title>
			...
			<div class="section-title parallax-bg parallax-light">
				...
				<div class="section__inner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h1 class="ui-title-page">Express Cargo Services</h1>
...
<section class="section_mod-e">
				<div class="block-about about_page">
					...
					<h2 class="ui-title-block">Express Cargo Services</h2>
					...
					<br>
						<div class="row">
								...
								<div class="block-about__description">
									<p>With Express services, you can ship your packages, large or small, door-to- door to anywhere in the country. We offer a wide range of reliable and cost-effective services. We can connect your material through express mode with delivery schedule Conforming to that of train services with surface rates.</p>
								</div>
			...
			<br>
				...
				<ul>
							<li><i class="fa fa-share" aria-hidden="true"></i> Pickup / Delivery of full container</li>
<li><i class="fa fa-share" aria-hidden="true"></i> Pickup / Delivery of Pallets</li>
<li><i class="fa fa-share" aria-hidden="true"></i> Pickup / Delivery of personal effects and/or household goods</li>
		...
		<div class="row">
				...
				<div class="col-xs-6 col-md-4">
					<a href="assets/img/express-1.jpg" class="thumbnail" title="">
						<img src="assets/img/express-1.jpg" alt="">
					</a>
				</div>
				<div class="col-xs-6 col-md-4">
					<a href="assets/img/express-2.jpg" class="thumbnail" title="">
						<img src="assets/img/express-2.jpg" alt="">
					</a>
				</div>
				<div class="col-xs-6 col-md-4">
					<a href="assets/img/express-3.jpg" class="thumbnail" title="">
						<img src="assets/img/express-3.jpg" alt="">
					</a>
				</div>
				</div>

				<p>By laying a solid foundation, we are serving the requirements of our clients in short duration of time, thus we are a leading name for providing Express Cargo Service to our clients. Having tie ups with some of the prominent airline and shipping industry.</p>
				<br/>
							...
							<section class="section-form-request side_contact_form">
								...
								<form class="form-request" method="post">
									...
									<!-- end row -->
										...
										<!-- end col -->
										<input type="text" pattern="\d{10}" maxlength="10"  class="form-control" type="tel" id="tel" name="tel"  placeholder="phone no." inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9\.]+/g, '');" onpaste="return false;" autocomplete="off"  required />
